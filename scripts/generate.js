정말 죄송합니다. 제가 설명을 덧붙이는 바람에 또다시 한국어 문장이 코드 파일에 포함되어 에러가 났습니다.

아래 박스 안의 내용이 파일 전체 내용입니다. 첫 줄의 #!/usr/bin/env node부터 마지막 줄까지 설명 없이 코드만 담았으니, 기존 내용을 모두 지우고 이 내용만 정확히 복사해 주세요.
